...
export default function ChangePassword(props: any) {
    ...
    return (
        ...
        <div className=' h-full w-full flex flex-col items-center justify-center ' >  
            ...
            <div className=' w-[600px] mb-12 border-2 border-[#EAEAEA] rounded-lg px-14 pb-10 pt-14 mt-24 flex flex-col items-center  ' > 
                <img className='w-40 h-40 rounded-full object-cover' src={userData.avatar ? userData.avatar : Avater } alt=""/> 
                <p className=' font-Ubuntu-Bold text-2xl mt-6 ' >Password Recovery</p>
                <p className=' font-Ubuntu-Regular  ' >Please enter your new password</p>
                <div className='w-full mt-8' >
                    <p className='text-sm mb-1 font-Ubuntu-Medium '>Confirm Password</p>   
                    <Input 
                        name="password"
                ...
                <div className=' w-full mt-4' >
                    <p className='text-sm mb-1 font-Ubuntu-Medium '>New Password</p>   
                    <InputGroup >
                        <InputRightElement 
                        children={
                ...
                <div className='w-full mt-8' > 
                    {loading ? 
                        <button className='font-Ubuntu-Medium text-xs text-white bg-[#7123E2] flex justify-center items-center rounded-lg h-12 px-6 w-full ' >
                            <div className='flex items-center' >
                                <LoaderIcon size='w-7 h-7 mr-1' /> 
                                Loading
                            </div> 
                        </button>:
                        <button onClick={()=> submit()} className='font-Ubuntu-Bold text-sm border text-[#fff] bg-[#7123E2] rounded-lg h-12 px-6 w-full ' >Update Password</button>
                    }
                </div>
                <button onClick={()=> LogOut()} className=' border font-Ubuntu-Medium text-sm border-[#7123E2] text-[#7123E2] rounded-lg h-12 w-full mt-4 px-6 ' >Log Out</button> 
            </div>
