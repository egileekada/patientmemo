            ...
            :
                <div className='w-full px-12' >
                    <div className='w-full flex ' > 
                        ...
                        <div className='ml-3' > 
                            <p className='font-Ubuntu-Medium text-lg' >Pharmacy Request for Adeyoni Josephine</p>
                            <p className='font-Ubuntu-Regular text-[#5F6777] mt-2 text-xs' >12:00pm, 12, Jun 22</p>
                        </div>  
