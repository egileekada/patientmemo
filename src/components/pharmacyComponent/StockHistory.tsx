import { InputGroup, InputLeftElement, Input, Table, Tbody, Td, Tr } from '@chakra-ui/react'
        ...
        <div className='w-full  ' >
            ...
            <div className='w-full relative h-48 flex' >
                ...
                <div className='w-full mb-6 flex items-center pl-12 pr-5 z-30 mt-auto relative' >
                    ...
                    <div className='ml-3' > 
                        <p className='font-Ubuntu-Medium text-lg text-white' >Stock Report</p>
                                                        ...
                                                        <Td> 
                                                            <div className='flex items-center w-full' > 
                                                                <div className=' w-14 h-14 rounded-full bg-yellow-300' >
                                                                    <GetUserInfo data={item.admin} image={true} />
                                                                </div>
                                                                
                                                                <div className=' ml-3' > 

                                                                <GetUserInfo data={item.admin} />
