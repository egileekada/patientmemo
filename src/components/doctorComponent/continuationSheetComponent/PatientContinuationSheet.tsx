        ...
        <div className='w-full h-full px-16  ' >
            <div className='w-full pt-8 flex items-center' > 
                ...
                <div className='ml-3' > 
                    ...
                    <p className='font-Ubuntu-Regular mt-2 text-sm' >12:00PM, 24, Jun 2021 - 12:00PM, 24, Jun 2022</p>
                </div>
            ...
            <p className='text-[#5F6777] ml-10  font-Ubuntu-Bold mt-6' >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Interdum in rutrum nisi venenatis</p>
