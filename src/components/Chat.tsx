...
export default function Chat() {
    ...
    const socket : any= io("https://hospital-memo-api.herokuapp.com");
                    ...
                    <div className=' w-fit overflow-y-auto ' > 
                        <div className={" w-full lg:flex flex-col hidden  pt-24  lg:w-[400px] px-4"}>  
                            <div className='  w-28 h-28 mt-8 mb-4 rounded-full mx-auto  ' >
                                <img className='w-full h-full rounded-full object-cover' src={userData.avatar} alt='avatar'  />
                            </div>
                            ...
                            <p className=' text-base font-Ubuntu-Medium mt-4 ' >12 participant</p>
                            <button onClick={()=> setShowModal((prev)=> !prev)} style={{boxShadow: "0px 4px 10px 0px #6C6C6C26"}} className=' my-3 p-4 mt-4 rounded-md flex items-center '  >
                        ...
                        <div  className=' flex flex-col h-screen flex-1 p-6 bg-[#FFFFFF] border-l  ' >
                            <div style={{boxShadow: "0px 0px 4px 0px #00000040"}} className=' w-full relative h-screen mt-24  rounded-xl  ' > 
                                ...
                                <div className=' absolute py-3 px-6 rounded-xl inset-x-0 inset-0 bottom-24 lg:ml-2 top-32 overflow-y-auto pb-4 text-black flex flex-col-reverse ' >  
                                    {/* Sender */}
                                    <div className=' w-fit flex flex-col ml-auto my-1 ' > 
                                        <div style={{boxShadow: "0px 0px 7.387387752532959px 0px #0000001A"}} className=' w-fit relative rounded-lg ml-auto flex flex-col items-center py-3 px-2 ' >
                                            <p className=' font-Mulish-Regular  text-base '>Last Message</p>
                                        </div>
                                    ...
                                    {/* Reciever */}
                                    <div className=' w-fit flex flex-col my-1 ' > 
                                ...
                                <div className=' w-full flex absolute border-t border-[#D1D1D1] bottom-1 px-5 py-4' > 
                                    <div className=' w-full relative pr-1 flex items-center ' >
                                        <Input backgroundColor="#fff" fontSize="sm" size="lg" borderRadius="16px" placeholder='Write your message here' /> 

                                        <button className=' px-2 flex h-full justify-center items-center ' > <svg width="62" height="61" viewBox="0 0 62 61" fill="none" xmlns="http://www.w3.org/2000/svg">
