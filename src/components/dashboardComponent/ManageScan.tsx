            ...
            <div className='w-full h-full px-6 flex ' >
                <div className='h-auto border-r border-[#D7D0DF] pl-4 pr-8 pb-10 ' >
                    ...
                    <div className='mt-8' >
                        ...
                        <p className='font-Ubuntu-Medium text-sm mt-2' >Abayomi Josephine</p>
                        <button className='text-xs font-Ubuntu-Bold px-4 rounded-md py-3 bg-[#7123E2] mt-3 text-white' >Grant Request/Upload Result</button>
                    </div>
                    <div className='mt-8' >
                        <div className='w-8 h-8 rounded-full flex bg-[#7123E214] justify-center items-center' >
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex flex-1 py-10 px-7' >
                    <div className='w-full grid grid-cols-3 gap-6' >
                        ...
                        <div className='w-full h-52 border-dashed border py-7 px-5' > 
                            <div className='flex items-center mb-5' > 
                                ...
                                <svg className='ml-auto cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className=' text-xs underline ml-auto mt-3 mb-5  font-Ubuntu-Medium w-full flex justify-end' >0 <span className='text-[#B0BAC8] ml-2' >uploaded</span></p>
