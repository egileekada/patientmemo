    ...
    return (
        <div className='w-full h-full ' >
            <div className='w-full px-12 border-b py-5 flex items-center border-[#D7D0DF]' > 
                ...
                <button className='font-Ubuntu-Medium text-xs bg-[#7123E2] text-white rounded-lg py-3 px-6 ml-auto ' >Add New Patient</button>
            </div>
            <div className='w-full grid grid-cols-4 bg-white relative z-50 gap-6 mt-8 px-8 py-6' >
                <div onClick={()=> navigate('/dashboard/patientfile')} className=' bg-[#7123E2] py-6 px-4 cursor-pointer text-white relative ' >
                    ...
                    <p className='font-Ubuntu-Medium mt-2 relative z-50' >Abayomi Josephine</p>
                    <div className='flex w-full items-center mt-2 relative z-50' >
                        ...
                        <p className='font-Ubuntu-Regular ml-2 text-sm' >090 67865736</p>
                    </div>
                    <div className='flex w-full items-center mt-2 relative z-50' >
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className='font-Ubuntu-Regular ml-2 text-sm' >Port Harcourt, Rivers State</p>
                    </div>
