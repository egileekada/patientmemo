    ...
    return (
        <div className='w-full h-full ' >
            ...
            <div className='w-full h-full px-6 flex ' >
                <div className='h-auto w-4/12 border-r border-[#D7D0DF] px-4 ' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >Prev. Medical History</p>
                    </div>
                    <div style={{width: '1px', marginLeft: '19px'}} className='h-10 bg-[#5F6777]' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >Special Report</p>
                    </div>
                    <div style={{width: '1px', marginLeft: '19px'}} className='h-10 bg-[#5F6777]' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >History of Present Preg.</p>
                    </div>
                    <div style={{width: '1px', marginLeft: '19px'}} className='h-10 bg-[#5F6777]' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >Physical Examination</p>
                    </div>
                    <div style={{width: '1px', marginLeft: '19px'}} className='h-10 bg-[#5F6777]' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >Follow up visit</p>
                    </div>
                    <div style={{width: '1px', marginLeft: '19px'}} className='h-10 bg-[#5F6777]' >
                    ...
                    <div className='flex items-center' >
                        ...
                        <p className={!next ? 'text-sm font-Ubuntu-Medium ml-3 text-[#5F6777]': 'text-sm font-Ubuntu-Medium ml-3 text-[#7123E2]'} >Pelvic Assessment</p>
                    </div>
                </div>
