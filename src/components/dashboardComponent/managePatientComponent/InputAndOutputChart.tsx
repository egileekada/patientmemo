...
export default function InputAndOutputChart() {
    return (
                ...
                <div className=' w-full py-12' >
                    ...
                    <div className='w-full mt-6' >
                        <div className='w-full flex items-center py-2 bg-[#F0F5FF] px-3' >
                            ...
                            <p className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >IVF soluble saline</p>
                        </div>
                        <div className='w-full flex items-center py-2 px-3' >
                            <p className='text-[#5F6777] text-sm font-Ubuntu-Regular ' >Amount:</p>
                            <p className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >500mls</p>
                        </div>
                        <div className='w-full flex items-center py-2 bg-[#F0F5FF] px-3' >
                            <p className='text-[#5F6777] text-sm font-Ubuntu-Regular ' >Urine:</p>
                            <p className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >900m/s</p>
                        </div>
                        <div className='w-full flex items-center py-2 px-3' >
                            <p className='text-[#5F6777] text-sm font-Ubuntu-Regular ' >Emesis:</p>
                            <p className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >----</p>
                        </div>
                        <div className='w-full flex items-center py-2 bg-[#F0F5FF] px-3' >
                        ...
                        <div className='w-full flex items-center py-2 px-3' >
                            ...
                            <p className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >Nancy</p>
                        </div> 
                    </div> 
                </div> 
                    ...
                    <div className=' w-full bg-[#7123E2] rounded-md text-white py-12 px-2' >
                        ...
                        <div className='w-full mt-6' >
                            <div className='w-full flex items-center py-2 bg-[#FFFFFF4F] px-3' >
                                ...
                                <p className='text-sm font-Ubuntu-Medium ml-auto  ' >IVF soluble saline</p>
                            </div>
                            <div className='w-full flex items-center py-2 px-3' >
                                <p className='text-sm font-Ubuntu-Regular ' >Amount:</p>
                                <p className='text-sm font-Ubuntu-Medium ml-auto  ' >500mls</p>
                            </div>
                            <div className='w-full flex items-center py-2 bg-[#FFFFFF4F] px-3' >
                                <p className='text-sm font-Ubuntu-Regular ' >Urine:</p>
                                <p className='text-sm font-Ubuntu-Medium ml-auto  ' >900m/s</p>
                            </div>
                            <div className='w-full flex items-center py-2 px-3' >
                                <p className='text-sm font-Ubuntu-Regular ' >Emesis:</p>
                                <p className='text-sm font-Ubuntu-Medium ml-auto  ' >----</p>
                            </div>
                            <div className='w-full flex items-center py-2 bg-[#FFFFFF4F] px-3' >
                            ...
                            <div className='w-full flex items-center py-2 px-3' >
                                ...
                                <p className='text-sm font-Ubuntu-Medium ml-auto  ' >Nancy</p>
                            </div> 
                        </div>  
                    </div> 
                </div>
