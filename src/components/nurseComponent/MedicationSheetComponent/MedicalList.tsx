                            ...
                            <div className=' w-full py-6 rounded-md px-2' >
                                ...
                                <div className='w-full mt-6' >
                                    <div id='cubediv' className='w-full flex items-center py-2 bg-[#F0F5FF] px-3' >
                                        ...
                                        <p id='cubetext' className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >{data?.data?.fertalHeartRate}</p>
                                    </div>
                                    <div className='w-full flex items-center py-2  px-3' >
                                        <p id='cubetext' className='text-[#5F6777] text-sm font-Ubuntu-Regular ' >Nurse:</p>
                                        <p id='cubetext' className='text-sm font-Ubuntu-Medium ml-auto text-[#7123E2]  ' >{data?.data?.nurse?.firstName+" "+data?.data?.nurse?.lastName}</p>
                                    </div>
                                    ...
                                    <div id='cubediv' className='w-full flex flex-col py-2  px-3' > 
                                        <p id='cubetext' className='text-sm font-Ubuntu-Medium  ' >{data?.data?.remark}</p>
                                    </div> 
                                </div> 
                            </div>
                        </div> 
