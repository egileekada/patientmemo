...
export default class App extends React.Component<{}, {}> {
    ...
    private eventTemplate(props:  { [key: string] : object}): JSX.Element{ 
        return(
            <div onClick={()=> ClickHandler()} className='template-wrap'> 
                ...
                <div className='mt-8' >
                    <p className='font-Ubuntu-Regular text-center mt-2 text-sm ' style={{color: '#6A5971'}} >10:00 - 11:35</p>
                    <div className='flex items-center' >
                        <div style={{backgroundColor:'#7123E2'}} className='mr-2 w-2 h-2 rounded-full' />
