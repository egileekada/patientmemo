        ...
        <div className='w-full h-full relative' >
            ...
            <div className='w-full relative px-12 border-b flex items-center border-[#D7D0DF]' >  
                ...
                <div className='mx-auto flex' >
                    ...
                    <div onClick={()=> navigate('/dashboard/profile')} className={tab === 2 ? 'flex items-center pb-7 pt-8  ml-4 cursor-pointer mx-3 border-b-2 border-[#7123E2] ': 'flex items-center ml-4 pb-7 pt-8  cursor-pointer mx-3 border-b-2 border-transparent '} > 
                        <p className={tab === 2 ? 'font-Ubuntu-Medium px-2 text-xs text-[#7123E2]': 'font-Ubuntu-Medium px-2 text-xs text-[#817D83]'} >Profile</p>
                    </div>
                </div>
